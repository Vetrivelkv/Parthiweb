...
const Package = () => {
  return (
    <div>
      <div
        style={{ color: "#F71C52", fontWeight: "bold", textAlign: "center" }}
      >
      ...
      >
        <div className="pacakgeContainer">
          ...
          <div>
            <p style={{ fontSize: "12px", lineHeight: "20px" }}>
              click edit button to change this text. Lorem Ipsum is simply dummy
        ...
        <div className="pacakgeContainer">
          <div style={{ paddingTop: "4%" }}>
            <p
              style={{ fontWeight: "bold", fontSize: "20px", color: "#F71C52" }}
            >
              Standard
            </p>
          </div>
